...
""".strip().format(class_name=self.__class__.__name__,
    ...
    def set_do_not_order_list(self, restricted_list, on_error='fail'):
        ...
        if isinstance(restricted_list, SecurityList):
            warnings.warn(
                ...
                "is deprecated. Use `set_restrictions("
                "security_list_restrictions.restrict_leveraged_etfs)` "
                "instead.",
                category=ZiplineDeprecationWarning,
                stacklevel=2
            )
            ...
            warnings.warn(
                ...
                "`set_restrictions(StaticRestrictions(container_of_assets))` "
                "instead.",
                category=ZiplineDeprecationWarning,
                stacklevel=2
            )
        ...
        self.set_restrictions(restrictions, on_error)
    ...
    def set_restrictions(self, restrictions, on_error='fail'):
        """Set a restriction on which assets can be ordered.
