...
class HistoryContainer(object):
    ...
    def __init__(self,
        ...
        initial_sids = [2608, 2678, 19920, 24705, 21519, 24, 8554]
        ...
        self.initial_dt = normalize_to_data_freq(self.data_frequency, initial_dt)
        #
    ...
    def get_history(self, history_spec, algo_dt):
        ...
        return self.data_portal.get_history_window(sids, algo_dt, 20, "daily", "open")
        ...
        # data_to_return = fast_build_history_output(digest_frame,
        #                                  last_period,
        #                                  algo_dt,
        #                                  index=index,
        #                                  columns=self.sids)
