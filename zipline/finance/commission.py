...
class PerShare(object):
    ...
    share cost with an optional minimum transaction cost.
    """

    def __init__(self, cost=0.03, min_cost=0.0):
        """
    ...
    def calculate(self, transaction):
        ...
        """
        return self.cost, max(self.min_cost, abs(transaction.amount * self.cost))
