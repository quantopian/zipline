...
class EventContainer(object):
    ...
    def add_event(self, rule=None, func=None, freq=None, start_dt=None):
    ...
    def handle_data(self, context, data, dt):
        """
        Calls registered events with the current
        algo datetime.
        """
...
class EventOffset(object):
    ...
    def __init__(self, rule=None, func=None, freq=None, start_dt=None):
        """
        Params:
            ...
            start_dt: tz-aware datetime obj <default=None>
        ...
        if hasattr(func, '__iter__'):
            ...
            self._funcs = [func]
        if start_dt is None:
            self.start_dt = tradingcalendar.start
        else:
            self.start_dt = start_dt.astimezone(pytz.utc)
