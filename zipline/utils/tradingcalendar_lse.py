...
class LseTradingCalendar(TradingCalendar):
    def __init__(self, start=datetime(2002, 1, 1, tzinfo=pytz.utc), end=None):
        super(LseTradingCalendar, self).__init__(start, end, 'Europe/London')
