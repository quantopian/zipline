...
class BlotterTestCase(WithCreateBarData,
    ...
    def test_blotter_order_types(self, style_obj, expected_lmt, expected_stp):
        ...
        blotter = SimulatedBlotter('daily')
    ...
    def test_blotter_eod_cancellation(self):
        blotter = SimulatedBlotter('minute', cancel_policy=EODCancel())
    ...
    def test_blotter_never_cancel(self):
        blotter = SimulatedBlotter('minute', cancel_policy=NeverCancel())
    ...
    def test_order_rejection(self):
        blotter = SimulatedBlotter(self.sim_params.data_frequency)
    ...
    def test_batch_order_matches_multiple_orders(self):
        ...
        order.
        """
        blotter1 = SimulatedBlotter(self.sim_params.data_frequency)
        blotter2 = SimulatedBlotter(self.sim_params.data_frequency)
        for i in range(1, 4):
            order_arg_lists = [
